...
Fairspec consists of five complementary JSON-based specifications:
...
**Fairspec File Dialect** - Defines file format dialects and their properties. Specifies how different file formats (CSV, TSV, JSON, JSONL, XLSX, ODS, Parquet, Arrow, SQLite) should be interpreted, including delimiters, headers, encoding, and format-specific settings.
